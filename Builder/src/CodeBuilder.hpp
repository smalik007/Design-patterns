...
struct Field {
  ...
  friend ostream& operator<<(ostream& os, const Field& obj) { return os << obj.type << " " << obj.name << ";"; }
};
...
class CodeBuilder {
 ...
 public:
  CodeBuilder(const string& class_name) { the_class.name = class_name; }
